...
package com.cl.learn.source.org.springframework.cglib.proxy;
...
import com.cl.learn.source.org.springframework.cglib.core.AbstractClassGenerator;
...
public class Enhancer extends AbstractClassGenerator {
    ...
    private Object createHelper() {
        ...
        Object key = KEY_FACTORY.newInstance((superclass != null) ? superclass.getName() : null,
                ...
                serialVersionUID);
        this.currentKey = key;
        Object result = super.create(key); // 根据key去创建代理对象
        return result;
    }
    ...
    protected Class generate(ClassLoaderData data) {
        validate();
        if (superclass != null) {
            setNamePrefix(superclass.getName()); //设置代理类前缀 superclass enhancer.setSuperclass(clazz);时设置为class com.cl.learn.cglib.UserServiceImpl
        }
    ...
    private Object createUsingReflection(Class type) {
        ...
        try {
            ...
            if (argumentTypes != null) {
                ...
                return ReflectUtils.newInstance(type, argumentTypes, arguments); // 根据代理类，创建代理对象
