...
package com.cl.learn.source.org.springframework.cglib.core;
...
abstract public class AbstractClassGenerator<T> implements ClassGenerator {
    ...
    protected Object create(Object key) {
        try {
            ...
            ClassLoaderData data = cache.get(loader); // ClassLoaderData 一个内部类
            if (data == null) {
                synchronized (AbstractClassGenerator.class) {
                    ...
                    if (data == null) {
                        ...
                        data = new ClassLoaderData(loader); // 创建ClassLoaderData
            ...
            this.key = key;
            // 通过ClassLoaderData.get() 获取代理类 get方法中其实是调用Enhancer.generate来创建代理类
            // this 是本AbstractClassGenerator对象，AbstractClassGenerator是 Enhancer 的父类
            // getUseCache() 是否缓存，默认有缓存，不会每次创建
            Object obj = data.get(this, getUseCache()); // 拿到代理类 class com.cl.learn.cglib.UserServiceImpl$$EnhancerByCGLIB$$e84bec64
